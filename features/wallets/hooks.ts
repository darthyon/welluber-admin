  ...
  const transactions: WalletTransaction[] = useMemo(() => {
    return [
      ...
      },
      {
        ...
        balanceAfter: 44499.50,
        voucherName: "Physio Therapy Voucher",
        claimId: "CLM-2026-0055",
        description: "Pre-auth locked — Physio session (pending claim)",
        performedBy: "Member App",
      ...
      },
      {
        ...
        balanceBefore: 44499.50,
        balanceAfter: 44499.50,
        voucherName: "Dental Care Voucher",
        claimId: "CLM-2026-0058",
        description: "Pre-auth locked — Dental checkup",
        performedBy: "Member App",
      ...
      },
      {
        ...
        voucherName: "Dental Care Voucher",
        claimId: "CLM-2026-0058",
        description: "Pre-auth cancelled — Dental checkup (member cancelled)",
        performedBy: "System",
      ...
      },
      {
        ...
        balanceBefore: 44499.50,
        balanceAfter: 44499.50,
        voucherName: "Wellness Massage Voucher",
        claimId: "CLM-2026-0062",
        description: "Pre-auth locked — Massage therapy session",
        performedBy: "Member App",
