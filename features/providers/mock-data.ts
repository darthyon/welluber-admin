    ...
    vouchers: [
      {
        ...
        summary: "Unlimited yoga classes for one month.",
        description: "Unlimited yoga classes for one month at any Zenith branch.",
        photos: ["https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?auto=format&fit=crop&q=80&w=800"],
        bookingRequired: true,
        displayLocation: { city: "Kuala Lumpur", state: "Wilayah Persekutuan" },
    ...
    vouchers: [
      {
        ...
        summary: "60-min private session with a licensed therapist.",
        ...
        bookingRequired: true,
        displayLocation: { city: "Petaling Jaya", state: "Selangor" },
