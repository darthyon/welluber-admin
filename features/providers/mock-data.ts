...
export const MOCK_SPS: ServiceProvider[] = [
  {
    ...
    commissionSchema: [
      { serviceCategory: "Yoga & Pilates", commissionRate: 0.12, expiredCommissionRate: 0.12, lastUpdated: "2026-01-10T00:00:00Z" },
      { serviceCategory: "Mental Health & Mindfulness", commissionRate: 0.20, expiredCommissionRate: 0.18, lastUpdated: "2026-01-10T00:00:00Z" },
    ],
    admins: [
    ...
    branches: [
      {
        ...
        name: "Zenith KLCC",
        services: ["Yoga & Pilates", "Mental Health & Mindfulness"],
    ...
    vouchers: [
      {
        ...
        serviceLines: [{ service: "Yoga & Pilates", subServices: ["Yoga"], description: "Unlimited drop-in sessions", duration: { unit: "month", value: 1 } }],
        status: "activated",
        isActive: true,
  ...
  },
  {
    ...
    commissionSchema: [
      { serviceCategory: "Mental Health & Mindfulness", commissionRate: 0.20, expiredCommissionRate: 0.18, lastUpdated: "2026-01-20T00:00:00Z" },
    ],
    admins: [
    ...
    branches: [
      {
        ...
        name: "AgileMind PJ",
        services: ["Mental Health & Mindfulness"],
    ...
    vouchers: [
      {
        ...
        serviceLines: [{ service: "Mental Health & Mindfulness", subServices: ["Therapy & Counselling"], description: "60-min licensed therapist session", duration: { unit: "hr", value: 1 } }],
        status: "activated",
        isActive: true,
      ...
      },
      {
        ...
        serviceLines: [{ service: "Mental Health & Mindfulness", subServices: ["Therapy & Counselling"], description: "5 sessions package", duration: { unit: "session", value: 5 } }],
        status: "draft",
        isActive: false,
  ...
  },
  {
    ...
    serviceCategories: ["Spa & Aesthetics", "Beauty & Personal Care"],
    ...
    commissionSchema: [
      { serviceCategory: "Spa & Aesthetics", commissionRate: 0.15, expiredCommissionRate: 0.15, lastUpdated: "2026-02-15T00:00:00Z" },
      { serviceCategory: "Beauty & Personal Care", commissionRate: 0.15, expiredCommissionRate: 0.15, lastUpdated: "2026-02-15T00:00:00Z" },
    ],
    admins: [
    ...
    branches: [
      {
        ...
        services: ["Spa & Aesthetics", "Beauty & Personal Care"],
  ...
  ...Array.from({ length: 5 }, (_, i) => ({
    ...
    taxProfile: { isTaxRegistered: false, taxRate: 0.08 },
    commissionSchema: [
      { serviceCategory: i % 2 === 0 ? "Fitness & Exercise" : "Nutrition & Dietetics", commissionRate: 0.12, expiredCommissionRate: 0.12, lastUpdated: "2026-03-01T00:00:00Z" },
    ],
    admins: [],
    branches: [],
    vouchers: [],
