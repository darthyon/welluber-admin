...
export type DependentCoverageType =
  | "spouse"
  | "child"
  | "mother"
  | "father"
...
export type BenefitGroupCoverageScope = "Employee" | "Dependent" | "Both"
...
export interface BenefitGroup {
  ...
  refreshCycle?: RefreshCycle // Optional override; unset = inherit from policy
}
