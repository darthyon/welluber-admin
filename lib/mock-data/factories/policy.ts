...
export function createPolicy(index: number): PolicyBundle {
  ...
  if (index === 0) {
    ...
    return {
      policy: {
        ...
        version: "V1.1",
        description:
          "Core employee wellness handbook policy for full-time staff coverage.",
  ...
  if (index === 1) {
    ...
    return {
      policy: {
        ...
        version: "V2.0",
        description:
          "Leadership-tier benefits handbook policy with expanded clinical therapy coverage.",
        organizationId: org.orgId,
  ...
  if (index === 2) {
    ...
    return {
      policy: {
        ...
        version: "V1.0",
        description:
          "Core logistics workforce handbook policy for contract and internship coverage.",
        organizationId: org.orgId,
  ...
  if (index === 3) {
    ...
    return {
      policy: {
        id,
        name: "Acme Engineering Wellness Supplement FY2026",
        code: "BEN-STD-01-ENG",
        description:
          "Engineering supplement with higher gym allocation than base policy.",
        ...
        groupCount: groups.length,
        orgName: org.orgName,
        targetEmployeeIds: ["EMP-20260115-0001"],
  ...
  if (index === 4) {
    ...
    return {
      policy: {
        id,
        name: "Acme Senior Band Wellness Supplement FY2026",
        code: "BEN-STD-01-SNR",
        version: "V1.1",
        description:
          "Senior band supplement with elevated therapy cap versus base policy.",
        parentPolicyId: parentId,
        organizationId: org.orgId,
        eligibleEmploymentTypes: ["full-time"],
        dependentCoverages: [],
        ...
        groupCount: groups.length,
        orgName: org.orgName,
        targetEmployeeIds: ["EMP-20260115-0002", "EMP-20260115-0004"],
