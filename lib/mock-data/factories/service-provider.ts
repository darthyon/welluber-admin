...
const GENERATED_SPS = [
  {
    name: "PrimeFit Gym & Studio",
    brandId: "BRD-20260401-0005",
    cats: ["Fitness & Exercise"],
    services: ["Gym Access", "Group Fitness Classes"],
    status: "active" as const,
  },
  {
    name: "Luminary Nutrition Hub",
    brandId: "BRD-20260401-0006",
    cats: ["Nutrition & Dietetics"],
    services: ["Nutritional Counselling", "Meal Planning"],
    status: "active" as const,
  },
  {
    name: "Vertex Physiotherapy Centre",
    brandId: "BRD-20260401-0007",
    cats: ["Recovery & Rehabilitation", "Medical & Allied Health"],
    services: ["Physiotherapy", "Sports Recovery"],
    status: "active" as const,
  },
  {
    name: "Apex Occupational Health",
    brandId: "BRD-20260401-0008",
    cats: ["Fitness & Exercise"],
    services: ["Health Screening", "Ergonomic Assessment"],
    status: "active" as const,
  },
  {
    name: "Nova Mindfulness Studio",
    brandId: "BRD-20260401-0009",
    cats: ["Mental Health & Mindfulness"],
    services: ["Meditation", "Mindfulness Workshops"],
    status: "pending" as const,
  },
  {
    name: "Horizon Beauty & Wellness",
    brandId: "BRD-20260401-0010",
    cats: ["Spa & Aesthetics", "Beauty & Personal Care"],
    services: ["Facial Treatments", "Skincare Consultations"],
    status: "active" as const,
  },
]
...
export function createServiceProvider(index: number): ServiceProvider {
  if (index === 0)
    return {
      ...
      description:
        "Premium yoga and mindfulness centre with certified instructors.",
      ...
      commissionSchema: [
        ...
        {
          mainService: "Therapy & Counselling",
          firstLevelQty: 0,
          firstLevelRate: 0.25,
          subsequentLevelQty: 1,
      ...
      bankInfo: {
        bankName: "Maybank",
        accountNumber: "514011223344",
        accountName: "ZENITH YOGA STUDIO Sdn Bhd",
      },
      address: {
      ...
      vouchers: [
        {
          ...
          serviceLines: [
            {
              service: "Yoga",
              subServices: ["Vinyasa Yoga"],
              description: "Unlimited drop-in sessions",
              descriptionList: "• Unlimited access\n• Free mat provided",
            },
          ],
          status: "published",
          isActive: true,
          ...
          services: [
            {
              ...
              subServices: ["Individual Therapy", "Group Counselling"],
            },
          ],
          address: {
            line: "Level 10, PJ Trade Centre",
            city: "Petaling Jaya",
            state: "Selangor",
            country: "Malaysia",
            postalCode: "46200",
          ...
          serviceLines: [
            {
              ...
              description: "60-min licensed therapist session",
              descriptionList: "• 1-on-1 session\n• Licensed practitioners",
            },
          ],
          status: "published",
          isActive: true,
  ...
  if (index === 2)
    return {
      ...
      admins: [
        {
          id: "SPA-003",
          spId: "SP-20260201-0003",
          name: "Chong Wei Lin",
          email: "wei@corefit.my",
          status: "pending_activation",
          invitedAt: "2026-02-03T00:00:00Z",
          branchIds: [],
        },
      ],
      branches: [],
  ...
  if (index === 3)
    return {
      ...
      taxProfile: {
        isTaxRegistered: true,
        taxRegNo: "SST-2023-009012",
        taxRate: 0.08,
      },
      commissionSchema: [
        {
          mainService: "Traditional / Relaxation Massage",
          firstLevelQty: 0,
          firstLevelRate: 0.15,
          subsequentLevelQty: 1,
          subsequentLevelRate: 0.12,
      ...
      admins: [
        {
          ...
          name: "Mei Ling Tan",
          email: "mei@serenityspa.my",
          status: "active",
          invitedAt: "2026-02-12T00:00:00Z",
          branchIds: [],
        },
      ],
      branches: [
        {
          ...
          services: [
            {
              service: "Traditional / Relaxation Massage",
              subServices: ["Swedish Massage"],
            },
          ],
          address: {
            line: "Level 5, Pavilion Kuala Lumpur",
            city: "Kuala Lumpur",
            state: "Wilayah Persekutuan",
            country: "Malaysia",
            postalCode: "55100",
  ...
  return {
    ...
    commissionSchema: [
      {
        mainService: d.services[0] ?? "General",
        firstLevelQty: 0,
        firstLevelRate: 0.12,
        subsequentLevelQty: 1,
        subsequentLevelRate: 0.1,
