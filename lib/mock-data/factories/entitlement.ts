...
const ROWS: Omit<Entitlement, "id">[] = [
  { beneficiaryName: "Ahmad Faizal", type: "Employee", employeeId: "EMP-20260115-0001", employeeName: "Ahmad Faizal", policyId: "POL-20260115-0001", policy: "Acme Flexi Wellness Policy FY2026", benefitGroup: "Gym & Fitness", branchName: "Kuala Lumpur HQ", allocatedAmount: 350, usedAmount: 270, status: "active", poolType: "SharedWithEmployee" },
  { beneficiaryName: "Siti Rahmah", type: "Dependent", employeeId: "EMP-20260115-0001", employeeName: "Ahmad Faizal", policyId: "POL-20260115-0001", policy: "Acme Flexi Wellness Policy FY2026", benefitGroup: "Wellness Activities", branchName: "Kuala Lumpur HQ", allocatedAmount: 300, usedAmount: 200, status: "active", poolType: "SharedWithEmployee" },
  ...
  { beneficiaryName: "Robert Fox", type: "Employee", employeeId: "EMP-20260115-0007", employeeName: "Robert Fox", policyId: "POL-20260115-0001", policy: "Acme Flexi Wellness Policy FY2026", benefitGroup: "Gym & Fitness", branchName: "Kuala Lumpur HQ", allocatedAmount: 350, usedAmount: 95, status: "active", poolType: "Individual" },
]
