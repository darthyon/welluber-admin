...
export const MOCK_EMPLOYEES: EmployeeDirectoryItem[] = [
    ...
    benefitPolicies: [
      {
        ...
        assignedGroupIds: ["POL-20260115-0001-G1", "POL-20260115-0001-G2"],
    ...
    benefitPolicies: [
      {
        policyId: "POL-20260115-0001",
        policyName: "Acme Employee Wellness Policy FY2026",
        assignedGroupIds: ["POL-20260115-0001-G2"],
  ...
  },
  {
    ...
    orgId: "ORG-20260301-0002",
    name: "Priya Raj",
    email: "priya.r@globalhealth.com",
    organization: "Global Health Ltd",
    branch: "Global Health HQ",
    joinDate: "01 Apr 2026",
...
export const MOCK_EMPLOYEE_CLAIMS: EmployeeClaim[] = [
  ...
  },
  {
    ...
    voucherName: "Lifestyle Pocket Voucher",
    transactionType: "redemption",
    service: "Grab Food Voucher",
    provider: "Grab Malaysia",
    location: "Online",
    date: "03 Jan 2026",
    amount: 200,
    status: "confirmed",
  ...
  {
    id: "c7",
    voucherCode: "VCH-2026-0189",
    voucherName: "Lifestyle Pocket Voucher",
    transactionType: "redemption",
    service: "Hotel Stay",
    provider: "Marriott Putrajaya",
    location: "Putrajaya",
    date: "20 Mar 2026",
    amount: 200,
    status: "pre-auth",
