...
export const MOCK_POLICY_TEMPLATES: PolicyTemplate[] = [
  {
    ...
    prefill: {
      ...
      groups: [
        { id: "grp-standard-physical", policyId: "", name: "Physical Wellbeing", distributionType: "IndividualBenefitAmount" },
        { id: "grp-standard-mental", policyId: "", name: "Psychological Wellbeing", distributionType: "IndividualBenefitAmount" },
        { id: "grp-standard-nutrition", policyId: "", name: "Nutritional Support", distributionType: "IndividualBenefitAmount" },
      ],
      benefits: [
  ...
  },
  {
    ...
    prefill: {
      ...
      activationMode: "after_join",
      groups: [
        { id: "grp-exec-physical", policyId: "", name: "Physical Wellbeing", distributionType: "SharedAmount", maxUsagePerCycle: 4500 },
        { id: "grp-exec-care", policyId: "", name: "Personal Care", distributionType: "SharedAmount", maxUsagePerCycle: 3000 },
      ],
      benefits: [
  ...
  },
  {
    ...
    prefill: {
      ...
      activationMode: "after_join",
      groups: [
        { id: "grp-contractor-mental", policyId: "", name: "Psychological Wellbeing", distributionType: "IndividualBenefitAmount" },
        { id: "grp-contractor-physical", policyId: "", name: "Physical Wellbeing", distributionType: "IndividualBenefitAmount" },
      ],
      benefits: [
  ...
  },
  {
    ...
    prefill: {
      ...
      activationMode: "after_join",
      groups: [
        { id: "grp-mental-core", policyId: "", name: "Psychological Wellbeing", distributionType: "IndividualBenefitAmount" },
      ],
      benefits: [
