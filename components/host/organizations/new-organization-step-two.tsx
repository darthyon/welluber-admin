...
export function NewOrganizationStepTwo({
  ...
  return (
    <div className="animate-in space-y-6 duration-400 fade-in slide-in-from-bottom-4">
      <div
        id="hq-identity"
        ...
        <div className="space-y-6 p-6">
          <div className="flex items-center gap-2 pb-2">
            ...
            <div className="space-y-0.5">
              ...
              <p className="text-label text-muted-foreground">
                Basic identifiers for the headquarters branch.
              </p>
            </div>
          </div>
          <div className="space-y-1.5">
            ...
            <input
              ...
              className="h-10 w-full rounded-lg border border-border bg-background px-3 py-2 text-body font-medium text-foreground transition-all outline-none focus:border-primary/40 focus:ring-2 focus:ring-primary/10"
            />
          </div>
        </div>
      </div>
        ...
        <div className="space-y-6 p-6">
          <div className="flex items-center gap-2 pb-2">
            ...
            <div className="space-y-0.5">
              ...
              <p className="text-label text-muted-foreground">
                A dedicated account is created for the HQ branch. Top up after
                creation from the branch detail page.
              </p>
            </div>
          </div>
            ...
            <div className="space-y-5">
              <div className="space-y-1.5">
                ...
                <input
                  ...
                  className="h-10 w-full rounded-lg border border-border bg-background px-3 py-2 text-body font-semibold text-foreground transition-all outline-none focus:border-primary/40 focus:ring-2 focus:ring-primary/10"
                />
              </div>
              <div className="space-y-1.5">
            ...
            <div className="space-y-3 rounded-lg border border-border bg-muted/20 p-4">
              <div className="flex items-start gap-3 text-body text-subtle">
                ...
                <span>
                  ...
                  organisation level for all linked accounts.
                </span>
              </div>
              <div className="flex items-start gap-3 text-body text-subtle">
                <CheckCircle
                ...
                />
                <span>
                  A 1.5% administrative fee applies to all standalone accounts.
                </span>
              </div>
            </div>
          </div>
