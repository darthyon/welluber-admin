    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      >
        <div className="grid grid-cols-2 gap-x-6 gap-y-8 md:grid-cols-4">
          ...
          <DetailField label="Timezone" value={branchData.address.timezone} />
        </div>
      </DetailSection>
          ...
          <div className="relative z-10 space-y-6">
            <div className="flex items-start justify-between">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h4 className="font-semibold text-lead text-foreground tracking-tight">KL HQ Account</h4>
            ...
            <div className="pt-6 border-t border-border/40 grid grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <DetailField
                ...
                value={<span className="text-body font-semibold text-subtle">RM 5,000</span>}
              />
              <DetailField
      ...
      <DetailSection
        ...
        action={
          <Button
            ...
            className="text-label font-medium rounded-full flex items-center gap-2 transition-all"
          >
            <Plus size={14} weight="bold" />
            Send Invite
          </Button>
