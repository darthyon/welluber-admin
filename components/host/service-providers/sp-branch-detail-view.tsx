              ...
              <div className="p-6 space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-1.5">
                    <p className="text-caption font-semibold text-muted-foreground/80 tracking-tight">Branch status</p>
                    ...
                    <>
                      {groups.map((group) => (
                        <div key={group.category} className="rounded-lg border border-border bg-muted/20 p-4 space-y-3">
                          <div className="flex items-center justify-between gap-3">
                            <div>
                              <p className="text-nav font-semibold text-foreground uppercase tracking-wider">{group.category}</p>
                              <p className="text-caption text-muted-foreground">{group.services.length} Main Service{group.services.length !== 1 ? "s" : ""}</p>
                            </div>
                          </div>
                              ...
                              <div key={service.name} className="rounded-lg border border-border bg-card p-3 shadow-sm">
                                ...
                                <div className="mt-3 flex flex-wrap gap-1.5">
                                  {service.subServices.map((subService) => (
                                    <Badge key={subService} variant="secondary" className="text-caption font-medium">
                                      {subService}
                                    </Badge>
                                  ))}
                                </div>
                      ...
                      {customServices.length > 0 && (
                        <div className="rounded-lg border border-dashed border-border bg-muted/10 p-4 space-y-3">
                          <div>
                            <p className="text-nav font-semibold text-foreground uppercase tracking-wider">Custom Subservices</p>
                          </div>
            ...
            <div id="governance" className="bg-card border border-border rounded-lg shadow-sm overflow-hidden scroll-mt-32">
              <div className="p-6 space-y-6">
                ...
                <div className="space-y-8">
                  ...
                  <div className="space-y-4">
                    <p className="text-micro font-semibold text-muted-foreground uppercase tracking-widest px-1">Local Administrators</p>
                  ...
                  {/* PICs Section */}
                  <div className="space-y-4">
                    <p className="text-micro font-semibold text-muted-foreground uppercase tracking-widest px-1">Persons In Charge (PIC)</p>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="p-6 space-y-6">
                ...
                <div className="flex flex-wrap gap-2">
                  {(branch.benefits?.length ?? 0) > 0 ? (
                    ...
                    <p className="text-nav text-muted-foreground italic">No specific benefits listed.</p>
                  )}
                </div>
              </div>
            </div>
