  ...
  return (
    <div className="space-y-4">
      <div className="border border-border rounded-lg overflow-hidden bg-background">
        <div className="grid grid-cols-[1fr_120px_120px_120px] gap-4 px-4 py-3 bg-muted/20 border-b border-border">
        ...
        <div className="divide-y divide-border/50">
          {portfolioRows.length === 0 ? (
            ...
            portfolioRows.map((row: CommissionSchemaRow) => (
              <div key={row.mainService} className="grid grid-cols-[1fr_120px_120px_120px] gap-4 items-center px-4 py-4 hover:bg-muted/5 transition-colors">
