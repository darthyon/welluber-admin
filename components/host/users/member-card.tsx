      ...
      <div className="relative z-10 space-y-6">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="space-y-2.5">
            ...
            <span className="text-[12px] font-bold text-foreground/80 block truncate font-mono" title={member.email}>
              {member.email}
            </span>
          </div>
          ...
          <div className="space-y-2.5">
            <div className="flex items-center gap-1.5 text-muted-foreground/30">
              ...
              <span className="text-[11px] font-bold tracking-tight text-muted-foreground/60">Organization</span>
            </div>
            <span className="text-[12px] font-bold text-foreground truncate block" title={member.organization.name}>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="space-y-2.5">
            ...
            <span className="text-[12px] font-bold text-foreground truncate block font-mono" title={member.branch?.name || "-"}>
              {member.branch?.name || "-"}
            </span>
          </div>
