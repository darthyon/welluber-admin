  ...
  return (
    <div className="animate-in space-y-8 duration-500 fade-in slide-in-from-bottom-4">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <Button
              variant="secondary"
              size="lg"
              className="gap-2 text-body font-medium"
              onClick={onEdit}
            >
      ...
      <div className="min-w-0">
        ...
        {activeTab === "claims" && (
          <EmployeeClaimsTab employeeId={employee.id} />
        )}

        {activeTab === "vouchers" && (
          <EmployeeVouchersTab employeeId={employee.id} />
        )}
          ...
          >
            {employee.dependents.length === 0 ? (
              <div className="flex flex-col items-center rounded-lg border border-dashed border-border bg-muted/20 p-8 text-center">
                ...
                <h5 className="text-body font-semibold tracking-tight text-foreground">
                  0 Dependents
                </h5>
