      ...
      <div className="flex justify-end items-center h-full px-8 gap-6">
        ...
        <div className="relative group hidden md:block">
          ...
          <Input 
            ...
            className="pl-9 h-8 w-[240px] bg-muted/40 border-border/50 focus:bg-muted/60 focus:ring-1 focus:ring-primary/10 transition-all placeholder:text-muted-foreground/60 rounded-lg text-caption shadow-none"
          />
