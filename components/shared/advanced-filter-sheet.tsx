    ...
    <Sheet
      ...
      footer={
        <div className="flex w-full items-center justify-between gap-4">
          <Button variant="ghost" onClick={handleReset} className="text-body hover:bg-muted font-semibold text-muted-foreground">
            Clear All
          </Button>
          <Button onClick={onApply} className="text-body rounded-lg px-8 bg-primary hover:bg-primary/90 shadow-lg shadow-primary/20">
            Apply Filters
          </Button>
        </div>
      }
          ...
          <section className="space-y-4">
            ...
            <div className="space-y-5 pl-1">
              ...
              <div className="relative">
                 <label className="text-label font-semibold text-faint mb-2 block">Custom employee count</label>
                <input
                  type="number"
                  placeholder="Enter specific count..."
                  className="w-full h-11 px-4 rounded-lg border border-border bg-card text-body focus:ring-2 focus:ring-primary/20 outline-none transition-all"
                  value={customPax}
