        ...
        <div className="flex-1">
          <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-4">
              ...
              <div>
                <h1 className="text-heading font-semibold text-foreground text-balance">Add New Organisation</h1>
                <p className="text-subtle text-body mt-1">Register a new corporate client on the platform.</p>
              </div>
            </div>

            <form id="newOrgForm" onSubmit={handleSubmit(onSubmit)} className="space-y-6">
